...
const Home = () => {
  ...
  return (
    <div style={{backgroundImage: `url(${TravelImg})`, backgroundRepeat: 'no-repeat', backgroundSize:"cover", width: "100%"}} className='w-full h-screen grid grid-cols-1 sm:grid-cols-2 sm:p-4 object-contain'>
